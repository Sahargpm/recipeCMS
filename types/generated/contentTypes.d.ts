...
export interface ApiIngredientIngredient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ingredientList: Schema.Attribute.Component<'component.ingredients', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    RecipeName: Schema.Attribute.String;
    recipeSteps: Schema.Attribute.Component<'component.recipestep', true>;
    Ingredient: Schema.Attribute.Component<'component.ingredients', true>;
    Tags: Schema.Attribute.Component<'component.tags', false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRecipeStepRecipeStep extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    recipeName: Schema.Attribute.String;
    steps: Schema.Attribute.Component<'component.recipe-detail', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::recipe-step.recipe-step': ApiRecipeStepRecipeStep;
